...
<head>
<meta charset="UTF-8">
<title>Candidatura inviata — Studio FParchitetto</title>
...
<body>
  <div class="box">
    ...
    <p>Abbiamo ricevuto la tua candidatura per il reparto <strong><?= htmlspecialchars($reparto ?: 'Studio FParchitetto') ?></strong>. Ti risponderemo al più presto.</p>
